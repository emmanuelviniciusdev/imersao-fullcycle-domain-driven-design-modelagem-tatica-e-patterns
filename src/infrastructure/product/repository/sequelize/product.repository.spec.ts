...
describe('ProductRepository Integration Tests', () => {
    ...
    it('should throw an error if checkout was not found in the database', async () => {
    ...
    it('should find a persisted checkout in the database by ID', async () => {
        const productRepository = new ProductRepository()
    ...
    it('should persist a checkout in the database', async () => {
        const productRepository = new ProductRepository()
    ...
    it('should update a persisted checkout in the database', async () => {
        const productRepository = new ProductRepository()
